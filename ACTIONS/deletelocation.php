...
if ( !isset($_POST['deletelocation'], $_POST['deleteid']) ) { //IF all fields weren't filled in
...
if ($_POST['adminpass'] === $adminpass) {
	echo 'Correct admin password! Deleting location... <br>';

	$delloca = $_POST["deletelocation"];
	$delid = $_POST["deleteid"];

	$del = "DELETE FROM locations WHERE Location_Name = '$delloca' AND Location_ID = '$delid'";
