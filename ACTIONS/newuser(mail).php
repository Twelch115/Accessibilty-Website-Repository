...
if ( !isset($_POST['newusername'], $_POST['newpassword'], $_POST['newemail'], $_POST['adminpass'], $_POST['isadmin'], $_POST['newlocid'], $_POST['doemail']) ) { //IF all fields weren't filled in
...
if ($_POST['adminpass'] === $adminpass) {
	...
	if ($doemail == 1) {
		$message = "You have been added to 92 Donner Kings Stock Managment application!\n your username is $nuser, and your password is $npass.\n connect to the system at http://localhost/92dk/index.html";
		
		mail($nemail, '92DK User account created', $message);
	}	
