...
if ( !isset($_POST['password'], $_POST['email']) ) { //IF password or email were not filled in
...
$sql = "UPDATE accounts SET Acc_password = '$Password' WHERE Acc_email = '$Email'"; //set up the SQL query to update the password at the relevant email location
...
if($rs) //IF the rs query succeeds
{
	...
	echo ' <a href="../index.html">Return to login page.</a>'; //let user return to login
}
?> <!-- end php code -->